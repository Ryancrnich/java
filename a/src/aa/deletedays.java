...
/**
 * Servlet implementation class deletedays
 */
@WebServlet("/deletedays")
public class deletedays extends HttpServlet {
...
try{  
	...
	PreparedStatement ps=con.prepareStatement(  
		    	"select AID from taken WHERE namee = ?  datee= ? and starttime=?;"); 
		ps.setString(1,name);  
		 ps.setString(2,date);  
		 ps.setString(3,starttime);   
		    	...
		    	response.sendRedirect("schedue.jsp");
		    		...
		    		ps=con.prepareStatement( 
	     		    	"UPDATE taken SET taken = ? WHERE AID =?");
		    		String string ="false";
	    		 ...
	    		 ps.setInt(2,AID);  
	    		 	 ...
	    		 	 rs=ps.executeQuery();  
		      		 ...
		      		 ps=con.prepareStatement( 
		     		    	"Delete from mydb.taken(datee) WHERE AID=?; ");  
		     		    		 ps.setInt(1,AID);  
